...
button_Before_Ex = pygbutton.PygButton((button_width_pos, button_height_pos1, button_width, button_height), 'Flip A New Card')
button_Decision = pygbutton.PygButton((button_width_pos, button_height_pos2, button_width, button_height), 'Make A Decision')
button_Next = pygbutton.PygButton((button_width_pos, button_height_pos3, button_width, button_height), 'Next Round')
